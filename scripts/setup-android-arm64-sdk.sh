...
if [ "$NEOTERM_NDK_VERSION" = "26c" ]; then
	ANDROID_NDK_FILE=android-ndk-r26b-aarch64.zip
	ANDROID_NDK_SHA256=b931676ece9b83e64192f68b7302f967082b344fb4994e838a964f94bce00a11
...
if [ ! -d "$NDK" ]; then
	...
	neoterm_download https://github.com/lzhiyong/termux-ndk/releases/download/android-ndk/${ANDROID_NDK_FILE} \
