...
NEOTERM_PKG_DESCRIPTION="A fast, compliant alternative implementation of Python"
NEOTERM_PKG_LICENSE="MIT"
NEOTERM_PKG_MAINTAINER="@licy183"
_MAJOR_VERSION=2.7
NEOTERM_PKG_VERSION="7.3.15"
NEOTERM_PKG_SRCURL=https://downloads.python.org/pypy/pypy$_MAJOR_VERSION-v$NEOTERM_PKG_VERSION-src.tar.bz2
NEOTERM_PKG_SHA256=9e1a10d75eea8830f95035063e107bc7e4252a0b473407c929bf3d132ce6737f
...
NEOTERM_PKG_SUGGESTS="pypy-tkinter"
...
neoterm_step_make_install() {
	...
	rm -rf $NEOTERM_PREFIX/opt/pypy
	unzip -d $NEOTERM_PREFIX/opt/ pypy$_MAJOR_VERSION-v$NEOTERM_PKG_VERSION.zip
	mv $NEOTERM_PREFIX/opt/pypy$_MAJOR_VERSION-v$NEOTERM_PKG_VERSION $NEOTERM_PREFIX/opt/pypy
	ln -sfr $NEOTERM_PREFIX/opt/pypy/bin/pypy $NEOTERM_PREFIX/bin/
	ln -sfr $NEOTERM_PREFIX/opt/pypy/bin/libpypy-c.so $NEOTERM_PREFIX/lib/
}
...
neoterm_step_create_debscripts() {
	...
	rm -Rf $NEOTERM_PREFIX/opt/pypy/site-packages/*

	echo "Deleting *.pyc..."
	find $NEOTERM_PREFIX/opt/pypy/lib-python/ | grep -E "(__pycache__|\.pyc|\.pyo$)" | xargs rm -rf
	find $NEOTERM_PREFIX/opt/pypy/lib_pypy/ | grep -E "(__pycache__|\.pyc|\.pyo$)" | xargs rm -rf
