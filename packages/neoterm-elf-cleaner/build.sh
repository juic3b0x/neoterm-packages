NEOTERM_PKG_HOMEPAGE=https://github.com/neoterm/neoterm-elf-cleaner
...
NEOTERM_PKG_SRCURL=https://github.com/neoterm/neoterm-elf-cleaner/archive/v${NEOTERM_PKG_VERSION}.tar.gz
