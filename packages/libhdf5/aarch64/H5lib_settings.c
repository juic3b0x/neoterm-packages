...
const char H5libhdf5_settings[]=
	...
	"             Installation point: /data/data/io.neoterm/files/usr\n"
	"\n"
	"Compiling Options:\n"
	"------------------\n"
	"                     Build Mode: Release\n"
	...
	"                        LDFLAGS: -Wl,--as-needed -L/data/data/io.neoterm/files/usr/lib\n"
	"                     H5_LDFLAGS: \n"
	"                     AM_LDFLAGS: \n"
	"                Extra libraries: m;dl\n"
	"                       Archiver: /data/data/io.neoterm/files/usr/bin/ar\n"
	"                         Ranlib: /data/data/io.neoterm/files/usr/bin/ranlib\n"
	"\n"
	"Languages:\n"
	"----------\n"
	"                              C: YES\n"
	...
	"                    H5_CPPFLAGS: \n"
	"                    AM_CPPFLAGS: \n"
	"                         CFLAGS:  -std=c99 -Oz -fstack-protector-strong -I/data/data/io.neoterm/files/usr/include\n"
	...
	"                            C++: ON\n"
	"                   C++ Compiler: /data/data/io.neoterm/files/usr/bin/clang++ 15.0.7\n"
	"                      C++ Flags:  -Oz -fstack-protector-strong -I/data/data/io.neoterm/files/usr/include\n"
