NEOTERM_PKG_HOMEPAGE="https://github.com/poljar/weechat-matrix-rs"
NEOTERM_PKG_DESCRIPTION="Rust rewrite of the python weechat-matrix script"
NEOTERM_PKG_LICENSE="ISC"
NEOTERM_PKG_LICENSE_FILE="LICENSE"
NEOTERM_PKG_MAINTAINER="@neoterm"
_COMMIT=ca23e1745e6e2ba235550360e1def1457e2f3857
NEOTERM_PKG_VERSION=2022.10.04
NEOTERM_PKG_SRCURL="git+https://github.com/poljar/weechat-matrix-rs"
NEOTERM_PKG_SHA256=61d4d307167f274c1ee165a7021d5cda330a2331eb89e8add2f027becf8cae0c
NEOTERM_PKG_AUTO_UPDATE=false
NEOTERM_PKG_GIT_BRANCH=main
NEOTERM_PKG_DEPENDS="weechat, openssl"
...
neoterm_step_make() {
	...
	export WEECHAT_PLUGIN_FILE="$NEOTERM_PREFIX/include/weechat/weechat-plugin.h"
...
neoterm_step_make_install() {
	install -Dm755 target/${CARGO_TARGET_NAME}/release/libmatrix.so \
		"$NEOTERM_PREFIX/lib/weechat/plugins/matrix.so"
}
