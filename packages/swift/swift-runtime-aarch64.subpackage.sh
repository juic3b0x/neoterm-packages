NEOTERM_SUBPKG_DESCRIPTION="Swift runtime libraries for Android AArch64"
NEOTERM_SUBPKG_INCLUDE="opt/ndk-multilib/aarch64-linux-android/lib/lib[FXs]*.so"
...
neoterm_step_create_subpkg_debscripts() {
	...
	sed 's|@COMMAND@|ln -sf "'$NEOTERM_PREFIX'/opt/ndk-multilib/aarch64-linux-android/lib/lib$so.so" "$install_path"|' \
