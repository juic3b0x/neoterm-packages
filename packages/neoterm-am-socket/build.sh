NEOTERM_PKG_HOMEPAGE=https://github.com/neoterm/neoterm-am-socket
NEOTERM_PKG_DESCRIPTION="A faster version of am with less features that only works while Termux is running"
NEOTERM_PKG_LICENSE="GPL-3.0"
NEOTERM_PKG_MAINTAINER="@neoterm"
NEOTERM_PKG_VERSION=1.5.0
NEOTERM_PKG_SRCURL=https://github.com/neoterm/neoterm-am-socket/archive/refs/tags/${NEOTERM_PKG_VERSION}.tar.gz
