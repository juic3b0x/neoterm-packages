TERMUX_PKG_HOMEPAGE=https://github.com/neoterm/neoterm-root-packages
...
TERMUX_PKG_DEPENDS="neoterm-keyring"
...
termux_step_make_install() {
	mkdir -p $TERMUX_PREFIX/etc/apt/sources.list.d
	{
		...
		echo "deb https://repo.theworkjoy.com/apt/neoterm-root/ root stable"
...
termux_step_create_debscripts() {
	...
	if [ -d "$TERMUX_PREFIX/etc/neoterm/chosen_mirrors" ] || [ -f "$TERMUX_PREFIX/etc/neoterm/chosen_mirrors" ]; then
