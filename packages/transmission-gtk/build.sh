...
NEOTERM_PKG_DESCRIPTION="Easy, lean and powerful BitTorrent client (gtk3)"
...
NEOTERM_PKG_DEPENDS="glib, gtk3, gtkmm3, libatkmm-1.6, libc++, libcairomm-1.0, libcurl, libevent, libglibmm-2.4, libpangomm-1.4, libpsl, libsigc++-2.0, miniupnpc, natpmpc, openssl"
NEOTERM_PKG_CONFLICTS="transmission"
NEOTERM_PKG_REPLACES="transmission"
