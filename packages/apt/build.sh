...
TERMUX_PKG_SRCURL=https://deb.kaisenlinux.org/pool/main/a/apt/apt_${TERMUX_PKG_VERSION}.tar.xz
TERMUX_PKG_SHA256=55466c484aa64097ac20f538b4ae042e7f62e6116205418d11ea4fc9221d807e
# apt-key requires utilities from coreutils, findutils, gpgv, grep, sed.
TERMUX_PKG_DEPENDS="coreutils, dpkg, findutils, gpgv, grep, libandroid-glob, libbz2, libc++, libcurl, libgnutls, liblz4, liblzma, sed, neoterm-keyring, neoterm-licenses, xxhash, zlib, zstd"
