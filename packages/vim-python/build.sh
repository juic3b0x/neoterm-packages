...
NEOTERM_PKG_DEPENDS="libiconv, ncurses, vim-runtime, python"
...
"
NEOTERM_PKG_DESCRIPTION+=" - with python support"
# Remove share/vim/vim91 which is in vim-runtime built as a subpackage of vim:
NEOTERM_PKG_RM_AFTER_INSTALL+=" share/vim/vim91"
