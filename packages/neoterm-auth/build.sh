NEOTERM_PKG_HOMEPAGE=https://github.com/neoterm/neoterm-auth
NEOTERM_PKG_DESCRIPTION="Password authentication library and utility for Termux"
NEOTERM_PKG_LICENSE="GPL-3.0"
NEOTERM_PKG_MAINTAINER="@neoterm"
NEOTERM_PKG_VERSION=1.4
NEOTERM_PKG_REVISION=2
NEOTERM_PKG_SRCURL=https://github.com/neoterm/neoterm-auth/archive/v${NEOTERM_PKG_VERSION}.tar.gz
